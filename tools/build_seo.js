...
/* manifest for OG image generation (per-track + default) */
const manifest = { base: BASE, tracks: TRACKS.map(t => ({ tid:t.id, n:t.n, title:t.title, icon:t.icon||'', phase:t.phase })) };
